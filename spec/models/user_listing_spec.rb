...
RSpec.describe UserListing, type: :model do
  ...
  it 'should calculate monthly_cost' do
    listing = create(:listing, price: 1000000, maintenance: 1000, taxes: 100)
    user_listing = create(:user_listing, listing: listing, percent_down: 20, mortgage_years: 30, interest_rate: 0.03625, tax_rate: 0.25)
  ...
  it 'should calculate airbnb profit' do
    listing = create(:listing, price: 1000000, maintenance: 1000, taxes: 100)
    user_listing = create(:user_listing, listing: listing, percent_down: 20, mortgage_years: 30, interest_rate: 0.03625, tax_rate: 0.25, airbnb_daily_total: 100, airbnb_fill_days: 10)
  ...
  it 'should calculate rental income' do
    listing = create(:listing, price: 1000000, maintenance: 1000, taxes: 100)
    user_listing = create(:user_listing, listing: listing, gross_monthly_rental_income: 1000, tax_rate: 0.25)
    expect(user_listing.net_monthly_rental_income).to eq(750)
  end

  it 'should calculate rent to cost' do
    listing = create(:listing, price: 1000000, maintenance: 1000, taxes: 100)
    user_listing = create(:user_listing, listing: listing, gross_monthly_rental_income: 1000, percent_down: 20, mortgage_years: 30, interest_rate: 0.03625, tax_rate: 0.25, airbnb_daily_total: 100, airbnb_fill_days: 10)
